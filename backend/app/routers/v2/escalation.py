...
async def get_active_escalations(
    ...
    if current_user.role != "operator":
        raise HTTPException(status_code=403, detail="Only operators can view escalations")
...
async def get_escalation_detail(
    ...
    if current_user.role != "operator":
        raise HTTPException(status_code=403, detail="Only operators can view escalation details")
...
async def acknowledge_escalation(
    ...
    if current_user.role != "operator":
        raise HTTPException(status_code=403, detail="Only operators can acknowledge escalations")
...
async def resolve_escalation(
    ...
    if current_user.role != "operator":
        raise HTTPException(status_code=403, detail="Only operators can resolve escalations")
...
async def get_escalation_action_logs(
    ...
    if current_user.role != "operator":
        raise HTTPException(status_code=403, detail="Only operators can view action logs")
...
async def auto_escalate(
    ...
    if current_user.role != "operator":
        raise HTTPException(status_code=403, detail="Only operators can trigger auto-escalation")
...
async def auto_upgrade_priorities(
    ...
    if current_user.role != "operator":
        raise HTTPException(status_code=403, detail="Only operators can trigger auto-upgrade")
