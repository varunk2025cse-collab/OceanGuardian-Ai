...
def upgrade() -> None:
    ...
    if not _table_exists("check_in_schedules"):
        op.create_table(
            'check_in_schedules',
    ...
    if not _table_exists("check_in_requests"):
        op.create_table(
            'check_in_requests',
            sa.Column('id', sa.Integer(), nullable=False),
    ...
    if not _table_exists("safety_escalations"):
        op.create_table(
            'safety_escalations',
            sa.Column('id', sa.Integer(), nullable=False),
    ...
    if not _table_exists("missed_check_ins"):
        op.create_table(
            'missed_check_ins',
            sa.Column('id', sa.Integer(), nullable=False),
    ...
    if not _table_exists("operator_action_logs"):
        op.create_table(
...
def downgrade() -> None:
    ...
    op.drop_table('operator_action_logs', if_exists=True)
    op.drop_table('missed_check_ins', if_exists=True)
    op.drop_table('safety_escalations', if_exists=True)
    op.drop_table('check_in_requests', if_exists=True)
    op.drop_table('check_in_schedules', if_exists=True)
